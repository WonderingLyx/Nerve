from DeepClosing import DeepClosing
import yaml
import os
...
check_point_path = '/root/shared-nvme/lyx/Project/Nerve/Trial/Res/Model/DC/epoch=49-step=86250.ckpt'
config_path = '/root/shared-nvme/lyx/Project/Nerve/Trial/Nerve-sam2post/CONFIG/Nerve.yaml'
seg_path = '/root/shared-nvme/lyx/Project/Nerve/Trial/Res/Predicts/Predicts'
...
img_paths = [ f for f in os.listdir(seg_path) if f.endswith('.tif')]
...
for pred in tqdm(sorted_files):
    ...
    if idx != index:
        print(f"Finish process volume-{index}")
        index = idx
